        ...
        <div className="flex justify-between h-16 items-center">
          ...
          {isAuthenticated ? (
            ...
            <div className="hidden md:flex items-center space-x-4">
              <button onClick={() => navigate('/login')} className="px-4 py-2 text-gray-700 hover:text-gray-900">Login</button>
              <button onClick={() => navigate('/signup')} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">Sign Up</button>
            </div>
          )}
          ...
          <div className="md:hidden flex flex-col space-y-2 bg-white py-4 px-4 border-t">
            {isAuthenticated ? (
              <>
                ...
                <button onClick={handleLogout} className="px-4 py-2 rounded text-red-500 hover:bg-gray-200">
                  Logout
                </button>
              </>
            ) : (
              <>
                <button onClick={() => { navigate('/login'); setIsMobileMenuOpen(false); }} className="px-4 py-2 text-gray-700 hover:bg-gray-200">
                  Login
                </button>
                <button onClick={() => { navigate('/signup'); setIsMobileMenuOpen(false); }} className="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                  Sign Up
                </button>
              </>
            )}
